...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	prebuilts/tools-lineage/${HOST_OS}-x86/bin/mogrify -resize $$RESOLUTION -background black -gravity center -extent $$RESOLUTION -colors 256 $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGESCALEWIDTH $$IMAGESCALEHEIGHT 60 1" > $(INTERMEDIATES)/desc.txt; \
